...
namespace BetterGameUI.IL
{
    public class NPCHouseIconsScrollbarLoader
    {
        ...
        public static void Load()
        {
            ...
            try
            {
                global::IL.Terraria.Main.DrawNPCHousesInUI += Main_DrawNPCHousesInUI_NPCHouseIconsScrollbar;
            }
            catch (System.Exception e)
            {
                throw new Exception.FailedToLoadFeature("Mods.BetterGameUI.Config.Label.Feature_NPCHouseIconsScrollbar", e);
            }
        }
