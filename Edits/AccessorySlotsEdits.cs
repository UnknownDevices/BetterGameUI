...
namespace BetterGameUI.Edits
{
    public class AccessorySlotsEdits
    {
        ...
        public static void DrawScrollbar(int accessoryPerColumn, int slotsToRender, int scrollIncrement)
        {
            ...
            int chkMax = (int)(AccessorySlotLoaderReflection.GetDrawVerticalAlignment() +
                (accessoryPerColumn + 3) * 56 * Main.inventoryScale) + 4;
            int chkMin = (int)(AccessorySlotLoaderReflection.GetDrawVerticalAlignment() + (0 + 3) * 56 * Main.inventoryScale) + 4;
            ...
            int scrollDelta = ModAccessorySlotPlayerReflection.GetScrollbarSlotPosition(AccessorySlotLoaderReflection.ModSlotPlayer
                (Main.LocalPlayer));
            scrollDelta += Mod.ClientConfig.AccessorySlots_InvertWheelScroll ?
                PlayerInput.ScrollWheelDelta / 120 :
                -PlayerInput.ScrollWheelDelta / 120;
